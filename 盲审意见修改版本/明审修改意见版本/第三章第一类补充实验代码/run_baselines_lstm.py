# -*- coding: utf-8 -*-
"""Run fixed-length 1D-CNN and two-layer LSTM supplementary baselines.

This script is prepared for later execution. It is not run by Codex.
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Chapter 3 supplementary 1D-CNN and two-layer LSTM baselines."
    )
    parser.add_argument("--mat", default=C.MAIN_DATA_DEFAULT, help="MAT file with ProcessedData and targetLength.")
    parser.add_argument("--out", default="outputs/baselines_lstm", help="Output directory.")

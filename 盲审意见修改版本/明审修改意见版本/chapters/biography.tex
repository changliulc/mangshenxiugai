...
\cs_new_protected:Npn \__blind_bio_edu_item:nn #1#2
  {
    \par
    \noindent
    \skip_horizontal:N \l__xdu_bio_indent_dim
    \makebox[9.2em][l]{#1}
    \parbox[t]{\dim_eval:n { \linewidth - \l__xdu_bio_indent_dim - 9.2em }}{#2}
    \par
  }
\NewDocumentCommand{\bioeduitem}{mm}
  { \__blind_bio_edu_item:nn {#1} {#2} }
\ExplSyntaxOff
...
\bioeduitem{2018.09～2022.07}{河南工业大学，本科，专业：电子信息工程}

\bioeduitem{2023.09～2026.07}{西安电子科技大学，硕士研究生，专业：电子信息}
